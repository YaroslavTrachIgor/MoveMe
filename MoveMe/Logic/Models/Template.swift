...
extension Template {
    static let list = [
        ...
        ], defaultAudioPath: "spotifydown.com - Pon de Replay.mp3", defaultAudioName: "Rihanna - Pon de Replay"),
        ...
        ], defaultAudioPath: "2_Timpani Beat - Nana Kwabena.mp3", defaultAudioName: "Nana Kwabena - Timpani Beat"),
        Template(id: UUID(), name: "Template #3", iconName: "Template3", items: 6, duration: 6.6, example: "Reel3", slides: [
            ...
            Slide(id: UUID(), duration: 1.1, isHDApplied: false, isVideo: false),
            Slide(id: UUID(), duration: 1.1, isHDApplied: false, isVideo: false),
        ], defaultAudioPath: "Copy of Rockville - Patrick Patrikios.mp3", defaultAudioName: "Rockville - Patrick Patrikios"),
        Template(id: UUID(), name: "Template #4", iconName: "Template4", items: 10, duration: 10.9, example: "Reel4", slides: [
            ...
            Slide(id: UUID(), duration: 0.6, isHDApplied: false, isVideo: false),
            Slide(id: UUID(), duration: 1.7, isHDApplied: false, isVideo: false),
        ], defaultAudioPath: "Grand Avenue - Text Me Records _ Bobby Renz.mp3", defaultAudioName: "Bobby Renz - Text Me Records"),
        ...
        ], defaultAudioPath: "5_no ID - zuubamusic.mp3", defaultAudioName: "Template 5 Track")
    ]
}
